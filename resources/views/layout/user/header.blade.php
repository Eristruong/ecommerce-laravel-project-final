  ...
  <div class=" navbar-collapse justify-content-end inner-header" id="collapsibleNavbar">
    <ul class="navbar-nav" style="float: right;">
      ...
      <li class="nav-item cart-icon">
        ...
        <a class="nav-link btn btn-success" href="{{ url('List-Carts') }}"><i class="fas fa-cart-arrow-down"></i>
          <b>Giỏ hàng</b>
          @if (Session::has("Cart") != null)
          <span style="width: 25px;" id="total-quanty-show" class="badge badge-success ml-3">{{
            ...
            <div class="select-items">
              <table>
                <tbody>
                  ...
                  <tr>
                    <td class="si-pic"><img src="public/upload/{{ $item['productInfo']->productImage }}"
                        style="vertical-align: middle;  width:80px;margin-right: 30px" alt=""></td>
                    <td class="si-text">
                    ...
                    <td class="si-close">
                      <h4><a class="" data-id="{{ $item['productInfo']->productID }}" role="button"><i
                            class="far fa-times"></i></a></h4>
                    </td>
                  </tr>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          ...
          @endif
          @if ((Auth::check() && Auth::user()->typeuser == 'admin')||(Auth::check() && Auth::user()->typeuser ==
          'user'))
  ...
  <nav class="navbar hr  ">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-content">
        ...
        <h6 class="dropdown-item" href="">CSKH: <a href="" class="btn-outline-info">+0834474225</a> <i
