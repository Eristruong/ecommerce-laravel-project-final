                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnBoxedTextContentContainer">
                    <tbody><tr>
                        ...
                        <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #6c5ce7;">
                                <tbody><tr>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #D12A08;">
                            ...
                            <h1><span style="color:#A52A2A">Thông báo đặt hàng từ khách hàng {{ $name }}&nbsp;!</span></h1>
<br>
<em><strong>
...
- số lượng sản phẩm trong đơn : {{ $bills->totalQuanty }}<br>
- Tổng giá trị thanh toán {{ number_format($bills->totalPrice) }} vn₫ </strong></em><br>
<br>
Xác nhận đơn hàng ở mục Quản lí đơn hàng tại trang quản trị website linh kiện store
<br>
&nbsp;
                        </td>
                    </tr>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Comic Sans MS&quot;, &quot;Marker Felt-Thin&quot;, Arial, sans-serif; font-size: 16px; padding: 18px;">
                                <a class="mcnButton " title="Xem nhận đơn hàng của khách hàng" href="http://localhost/weblinhkien/admin/bill" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Xem đơn hàng của bạn</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
